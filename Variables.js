...
let myNames ='Keerthan';
let myCity= 'Manipal';
console.log(`My name is ${myNames}. My favorite city is ${myCity}. `);
...
/*
  ...
  7.String Concatenation with Variables
    ...
    In the example above, we assigned the value 'armadillo' to the myPet variable. On the second line, 
  ...
  8.String Interpolation
    ...
    left of the 1 key).
    Inside the template literal, you’ll see a placeholder, ${myPet}. The value of myPet is inserted into 
    ...
    literals, you can more easily tell what the new string will be. You also don’t have to worry about 
