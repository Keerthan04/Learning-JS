//when we need to use parameters too many times we use this to store it in the req object as a property
//merge parameters(nested routers) and using param
/*
  1.Introduction
  ...
  3.Merge Parameters
    ...
    //to pass the parameters of the parent router to the child routers when defineig the child router within the parent router we use mergeParams=true as obj passed i.e {mergeParams:true}
